...
func dataInventoryJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/inventory.json", size: 993, mode: os.FileMode(420), modTime: time.Unix(1528318154, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
